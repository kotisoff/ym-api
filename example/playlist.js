import YandexMusicApi from "../src/ym-api.js";
...
api
  ...
  .then(function (playlist) {
    ...
    return api
      .addTracksToPlaylist(playlist.kind, tracks, playlist.revision)
      .then(function (playlist) {
        console.log(
          "Added " + playlist.trackCount + " tracks to the playlist:"
        );
  ...
  .then(function (playlist) {
    ...
    return api
      .removeTracksFromPlaylist(playlist.kind, tracks, playlist.revision)
      .then(function (playlist) {
